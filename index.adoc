...
- the actual talk at ClojureD: link:talk-clojured-2018.html

- a more detailed presentation about Bolztmann sampling: link:talk-clojured-2018-bolzmann.html

- a complement presentation about the beautiful *bijective method* for the uniform random generation of binary trees and general trees: link:talk-clojured-2018-bingen.html 
