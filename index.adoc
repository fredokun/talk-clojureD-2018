...
- the actual talk at ClojureD: https://fredokun.github.io/talk-clojureD-2018/talk-clojured-2018.html

- a more detailed presentation about Bolztmann sampling: https://fredokun.github.io/talk-clojureD-2018/talk-clojured-2018-bolzmann.html

- a complement presentation about the beautiful *bijective method* for the uniform random generation of binary trees and general trees: https://fredokun.github.io/talk-clojureD-2018/talk-clojured-2018-bingen.html 
