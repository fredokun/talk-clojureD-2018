...
*Want to play with the slides?*
https://goo.gl/DLB2H9 (boltzmann) https://goo.gl/ZhhrEk (binary trees/complement)
...
Sampling of an object with a Boltmann model (tree grammar) `C` of parameter `z`:
